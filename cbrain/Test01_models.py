...
Author: Stephan Rasp
tgb - 1/15/2019 - Changing the densely connected neural network
to add mixed activation functions
"""
...
def fc_model(feature_shape, target_shape, hidden_layers, lr, loss,
    ...
    sx = Dense(3, activation='softmax', kernel_regularizer=l2)(x)
    lx = Dense(target_shape-3
