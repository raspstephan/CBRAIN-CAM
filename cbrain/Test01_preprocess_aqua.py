...
tgb - 1/14/2019 - Modify the preprocessing file to change inputs/outputs
in order to predict microphysics and improve stability
"""
import sys
import xarray as xr
import numpy as np
...
G = 9.80616
P0 = 1e5
RHO_L = 1e3 # Density of liquid water in kg/m3
conversion_dict = {
    'TPHYSTND': C_P/G,
    'TPHY_NOKE': C_P/G,
    'TPHYSTND_NORAD': C_P/G,
    'DTVKE': C_P/G,
    'PHQ': L_V/G,
    'PHCLDLIQ' : L_V/G,
    'PHCLDICE' : L_V/G,
