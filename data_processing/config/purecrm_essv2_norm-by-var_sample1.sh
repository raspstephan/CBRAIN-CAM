...
--out_pref purecrm_essv2_norm-by-var_norm-by-var_train_sample1 \
--norm_by_var &&
python $PROC_ROOT/preprocess_aqua.py \
--config_file $PROC_ROOT/config/pure_crm_essentials.yml \
--in_dir /beegfs/DATA/pritchard/srasp/Aquaplanet_enhance05/ \
...
--ext_norm /beegfs/DATA/pritchard/srasp/preprocessed_data/purecrm_essv2_norm-by-var_train_sample1_norm.nc \
--norm_by_var &&
python $PROC_ROOT/shuffle_ds.py \
--pref /beegfs/DATA/pritchard/srasp/preprocessed_data/purecrm_essv2_norm-by-var_train_sample1