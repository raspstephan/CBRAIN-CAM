...
--out_pref paper_nonorm_train_sample1 &&
python $REPO/cbrain/preprocess_aqua.py \
--config_file $REPO/pp_config/paper.yml \
--in_dir /scratch/srasp/Aquaplanet_enhance05/ \
--aqua_names='AndKua_aqua_SPCAM3.0_enhance05.cam2.h1.0001-*-0[5-9]-*' \
--out_dir /scratch/srasp/preprocessed_data/ \
--out_pref paper_nonorm_valid_sample1 \
--ext_norm /scratch/srasp/preprocessed_data/paper_nonorm_train_sample1_norm.nc &&
python $REPO/cbrain/shuffle_ds.py \
--pref /scratch/srasp/preprocessed_data/paper_nonorm_train_sample1