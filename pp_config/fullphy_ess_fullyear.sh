...
--out_pref fullphy_ess_train_fullyear &&
python $PROC_ROOT/preprocess_aqua.py \
--config_file $PROC_ROOT/config/full_physics_essentials.yml \
--in_dir /beegfs/DATA/pritchard/srasp/Aquaplanet_enhance05/ \
--aqua_names='AndKua_aqua_SPCAM3.0_enhance05.cam2.h1.0001-*' \
--out_dir /beegfs/DATA/pritchard/srasp/preprocessed_data/ \
--out_pref fullphy_ess_valid_fullyear \
--ext_norm /beegfs/DATA/pritchard/srasp/preprocessed_data/fullphy_ess_train_fullyear_norm.nc &&
python $PROC_ROOT/shuffle_ds.py \
--pref /beegfs/DATA/pritchard/srasp/preprocessed_data/fullphy_ess_train_fullyear