# tgb - 4/24/2019 - Data-scarce using just 1-file --> calculate statistics on +0,1,2,3,4K; NNU version
...
# 1) Load model
path = TRAINDIR+'HDF5_DATA/NNL0DS1_19.h5'
